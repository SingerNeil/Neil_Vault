...
我重新对照了本地视频 p125-p132、Chapter04 PPT 和 Lab2：Day 6 的视频是强匹配。

- `6-6-1` 对应 MIPS 五级流水线、吞吐率、流水线时序图。
- `6-6-2` 对应 pipelined datapath 和 pipeline registers。
- `6-6-3` 系列对应 structural hazard、data hazard、stall、forwarding、control hazard。
- `6-6-4` 是流水线习题，适合配合 Lab2 的 cycle diagram 和 pipeline register 问题。
- `6-6-3（5）进一步提升指令执行的并行性—超流水线技术和多发射技术` 没有列为必看，因为它偏扩展，不是学校 PPT / Lab2 的核心题型。

Day 6 可以按当前视频清单看，但做题仍以 PPT 页码和 Lab2 表格为准。
