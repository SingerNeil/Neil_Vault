...
| 目标芯片 | 发送指令 (PC -> MCU) | 预期响应 (MCU -> PC) | 描述 |
| :--- | :--- | :--- | :--- |
...
| 命令字 | 名称 | 方向 | 描述 |
| :--- | :--- | :--- | :--- |
| `0x01` | **START** | PC -> MCU | 传输开始，包含元数据 |
| `0x02` | **DATA** | PC -> MCU | 固件数据分片 |
| `0x03` | **END** | PC -> MCU | 传输结束，触发校验 |
| `0x10` | **ACK** | MCU -> PC | 成功确认 |
| `0x11` | **NACK** | MCU -> PC | 失败/错误 (含错误码) |
